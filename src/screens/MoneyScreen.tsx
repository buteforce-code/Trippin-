...
export function MoneyScreen() {
  ...
  const visibleExpenses = sortedExpenses.filter((e) => filter === 'all' || e.cat === (filter as CategoryKey))
        ...
        <div>
          <div style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(140deg,var(--green),#1f9b62)', borderRadius: 'var(--radius-lg)', padding: 18, marginTop: 14, color: '#fff', boxShadow: '0 14px 30px rgba(43,182,115,.34)' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div style={{ fontSize: 12.5, fontWeight: 600, opacity: 0.9, marginTop: 2 }}>of {fmt(summary.expected)} expected · ₹5,000 / head</div>
            </div>
          </div>
